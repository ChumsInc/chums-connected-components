...
export const selectCurrentPage = (key) => (state) => state.pageSets[key]?.page ?? defaultPageSet.page;
export const selectRowsPerPage = (key) => (state) => state.pageSets[key]?.rowsPerPage ?? defaultPageSet.rowsPerPage;
export const selectPageSet = (key) => (state) => ({ ...defaultPageSet, ...state.pageSets[key] });
